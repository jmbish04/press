/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 27d210efb3a26bec6a4ba8c15a9e73ed)
// Runtime types generated with workerd@1.20260603.1 2026-03-09 nodejs_compat
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	SPAWNED_PWAS: R2Bucket;
	DB: D1Database;
	...
	AI: Ai;
	ASSETS: Fetcher;
	NEWS_AGENT: DurableObjectNamespace<import("./src/_worker").NewsAgent>;
	ARTICLE_CHAT_AGENT: DurableObjectNamespace<import("./src/_worker").ArticleChatAgent>;
	INGEST_AGENT: DurableObjectNamespace<import("./src/_worker").IngestAgent>;
	PRESS_MCP: DurableObjectNamespace<import("./src/_worker").PressMcpAgent>;
	PROCESSING_MONITOR: DurableObjectNamespace<import("./src/_worker").ProcessingMonitor>;
	ARTICLE_INGESTION: Workflow<Parameters<import("./src/_worker").ArticleIngestionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/_worker");
		durableNamespaces: "NewsAgent" | "ArticleChatAgent" | "IngestAgent" | "PressMcpAgent" | "ProcessingMonitor";
	}

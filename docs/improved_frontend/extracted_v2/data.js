...
// Studio artifacts — visual PWAs & mind maps the agent built, saved to R2 + indexed in D1.
const ARTIFACTS = [
  { id: "art-1", type: "mindmap", title: "Mind map · Salary negotiation script", source: "1 article", date: "2d ago",
    tree: { label: "Salary negotiation script", hue: 150, children: [
      { label: "Before the number", children: [{ label: "Do your research" }, { label: "Anchor high" }] },
      { label: "After they name it", children: [{ label: "Repeat & pause" }, { label: "Let silence work" }] },
      { label: "Closing", children: [{ label: "Get it in writing" }, { label: "Thank & confirm" }] },
    ] } },
  { id: "art-2", type: "pwa", title: "Interview Prep Coach", source: "Tag · interviewing (3 articles)", date: "1d ago", app: "interview-coach", prompt: "interactive interview-prep coach with flashcards and a mock-interview timer" },
  { id: "art-3", type: "pwa", title: "PC Build Configurator", source: "Notebook · PC build research", date: "3d ago", app: "pc-builder", prompt: "a build-a-PC configurator that recommends parts for local AI inference under a budget" },
  { id: "art-4", type: "mindmap", title: "Mind map · Consumer tech trends", source: "Notebook · 5 articles", date: "5d ago",
    tree: { label: "Consumer tech trends 2026", hue: 200, children: [
      { label: "On-device AI", children: [{ label: "Memory bandwidth" }, { label: "Thermals" }] },
      { label: "Buying signals", children: [{ label: "GPU supply" }, { label: "Apple Silicon" }] },
      { label: "What to buy", children: [{ label: "Laptops" }, { label: "Workstations" }] },
    ] } },
];

Object.assign(window, { SOURCES, CATEGORIES, TAGS, ARTICLES, PROC_STAGES, PROC_JOBS, SAVED_VIEWS, NOTIFICATIONS, WORKERS_AI, GATEWAY_PROVIDERS, AURA_VOICES, ARTIFACTS });

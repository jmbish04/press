...
function Notebook({ openArticle, onGenerate }) {
      ...
      <div className="nb-chat">
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 26px", borderBottom: "1px solid var(--border)" }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            <Button variant="outline" size="sm" onClick={() => onGenerate("mindmap", scopeLabel)} title="Generate a mind map from these sources"><Icon name="share" size={13} />Map</Button>
            <Button variant="brand" size="sm" onClick={() => onGenerate("pwa", scopeLabel)} title="Build a PWA from these sources"><Icon name="sparkles" size={13} />Build</Button>
